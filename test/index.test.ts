import { convertPhoneNumberToInternationFormat, validatePhoneNumber } from '../src/index';

describe('convertPhoneNumberToInternationFormat', () => {
  it('should convert phone number to international format', () => {
    const phoneNumbers = ['07012345678', '7012345678', '23407012345678', '2347012345678', '+23407012345678', '+2347012345678'];
    const result = convertPhoneNumberToInternationFormat({ phoneNumbers });
    expect(result).toEqual(['2347012345678', '2347012345678', '2347012345678', '2347012345678', '2347012345678', '2347012345678']);
  })
  ...
  it('should convert phone number to international format with + prepend and append with #', () => {
    ...
    const result = convertPhoneNumberToInternationFormat({ phoneNumbers, options: { prepend: '+', append: '#' } });
